...
goodTaus = cms.EDFilter("PFTauSelector",
        ...
        cut = cms.string(
                ...
                '&& abs(charge) > 0 && abs(charge) < 2 ' #sometimes 2 prongs
        ),
...
Ntuplizer_noTagAndProbe_multipleTaus_AOD = cms.EDAnalyzer("Ntuplizer_noTagAndProbe_multipleTaus_AOD",
...
NtupleSeq = cms.Sequence(
    Ntuplizer_noTagAndProbe_multipleTaus_AOD
)
